...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category text-center font-weight-bold">Eagle@7</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='customers_report') }}">Companies Reports</a></li>
							@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@can('Employees List ')
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}"> Employees List</a></li>
							@endcan

							@can('Employees Permission ')
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}"> Employees Permissions</a></li>
							@endcan
