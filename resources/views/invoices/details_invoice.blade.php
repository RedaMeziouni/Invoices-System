...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> Invoices List</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Invoice Details </span>
            </div>
        </div>
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">Invoice Infos  </a></li>
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <th scope="row">Invoice Due date</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="row">Amount Commision </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="row">  Total (Tax included)</th>
