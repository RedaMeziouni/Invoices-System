        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="col-sm-1 col-md-2">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('users.create') }}"> Add Employee </a>
                    ...
                    <table class="table table-hover" id="example1" data-page-length='10' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">Email Adress</th>
                                <th class="wd-15p border-bottom-0">Employee Status</th>
                                <th class="wd-15p border-bottom-0">Employee Role</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title"> Delete Employee </h6><button aria-label="Close" class="close"
